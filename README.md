...
> [!TIP]
> **🚀 Quick Navigation (省流传送门)**
> Directly go to the action to earn badges:
> 
> *   💬 [**Discussions (讨论区)**](https://github.com/yuanweize/GitHub-Badges-Cheatsheet/discussions) - Earn `Galaxy Brain`
> *   🔀 [**Pull Requests (PR列表)**](https://github.com/yuanweize/GitHub-Badges-Cheatsheet/pulls) - Earn `Pull Shark` / `YOLO`
> *   🐛 [**Issues (议题)**](https://github.com/yuanweize/GitHub-Badges-Cheatsheet/issues) - Earn `Quickdraw`
